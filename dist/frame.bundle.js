...
/***/ function(module, exports, __webpack_require__) {
	...
	var _emotes = __webpack_require__(181);
	...
	var IMChat = function (_Component) {
	    _inherits(IMChat, _Component);

	    function IMChat(props) {
	        _classCallCheck(this, IMChat);

	        return _possibleConstructorReturn(this, Object.getPrototypeOf(IMChat).call(this, props));
	    }
	    ...
	    _createClass(IMChat, [{
	        ...
	        value: function render() {
	            ...
	            return _react2.default.createElement(
	                'div',
	                { id: _base2.default.page },
	                _react2.default.createElement(
	                    'div',
	                    { className: this.props.userName ? _base2.default.hide : _base2.default.loginForm },
	                    _react2.default.createElement(
	                        'form',
	                        { onSubmit: function onSubmit(e) {
	                                return _this2.setLogin(e);
	                            } },
	                        _react2.default.createElement('input', { ref: 'login', type: 'text', placeholder: 'Your nickname' }),
	                        _react2.default.createElement(
	                            'button',
	                            null,
	                            'Login'
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: this.props.userName ? _base2.default.chatWrapper : _base2.default.hide },
	                    _react2.default.createElement(
	                        'ul',
	                        { className: _base2.default.chat },
	                        this.props.messages.map(function (message, i) {
	                            var userNameReg = new RegExp(_this2.props.userName, 'g');
	                            var text = message.text;
	                            if (_this2.props.userName !== message.name) {
	                                text = message.text.replace(userNameReg, '<b>' + _this2.props.userName + '</b>', 'ig');
	                            }
	                            text = (0, _emotes2.default)(text);
	                            return _react2.default.createElement(
	                                'li',
	                                { className: _base2.default.message, key: i },
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: _base2.default.messageDate },
	                                    message.date.toString()
	                                ),
	                                _react2.default.createElement(
	                                    'span',
	                                    { className: message.name === _this2.props.userName ? _base2.default.messageOwner : _base2.default.messageUsername },
	                                    message.name,
	                                    ':'
	                                ),
	                                _react2.default.createElement('span', { className: _base2.default.messageText, dangerouslySetInnerHTML: { __html: text } })
	                            );
	                        })
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        { className: _base2.default.chatInput },
	                        _react2.default.createElement(
	                            'form',
	                            { onSubmit: function onSubmit(e) {
	                                    return _this2.sendMessage(e);
	                                } },
	                            _react2.default.createElement('input', { ref: 'message', type: 'text', placeholder: 'Enter the message' }),
	                            _react2.default.createElement(
	                                'button',
	                                null,
	                                'Send'
	...
	var render = function render() {
	    _reactDom2.default.render(_react2.default.createElement(IMChat, store.getState()), document.getElementById('main'));
	};
	...
	window.addEventListener('message', function (event) {
	    switch (event.data.type) {
	        case 'NEW_MESSAGE':
	            store.dispatch(_extends({}, event.data));
	            break;
	        default:
	            break;
	    }
...
/***/ function(module, exports) {
	...
	exports.default = replaceEmoticons;
	function replaceEmoticons(text) {
	    var folder = 'src/emotes/';
	    var emoticons = {
	        '>(': folder + 'angry.png',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		...
		if(!content.locals) {
			module.hot.accept("!!./../../../node_modules/css-loader/index.js?modules!./../../../node_modules/postcss-loader/index.js!./base.css", function() {
				var newContent = require("!!./../../../node_modules/css-loader/index.js?modules!./../../../node_modules/postcss-loader/index.js!./base.css");
